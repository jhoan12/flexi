...
const Sidebar = () => {
  ...
  return (
    <div className="">
      <Navbar className="box-shadow-navbar" expand="lg">
        <Container>
          <Navbar.Brand onClick={handleShow}>
            <FaBars className="sidebar-item-icon__menu" />
          </Navbar.Brand>
          <Navbar.Brand>
      ...
      <Offcanvas show={show} onHide={handleClose} style={{ maxWidth: "17em" }}>
        ...
        <Offcanvas.Body className="sidebarBody">
          <NavLink to="/" exact className="sidebar-item border-bottom mb-3">
            <GiHiking className="sidebar-item-icon" /> Progreso
          </NavLink>
          <NavLink to="/notificaciones" exact className="sidebar-item border-bottom mb-3">
